...
def process_file(input_path, output_path):
    ...
    code_key = "code" if "code" in data[0] else "text"
    ...
    with open("data/reports/model_scores.csv", "w", newline="") as f:
        writer = csv.writer(f)
    ...
    with open("data/reports/language_model_scores.csv", "w", newline="") as f:
        writer = csv.writer(f)
